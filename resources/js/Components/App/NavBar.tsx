...
const NavBar = () => {
    ...
    return (
        <>
            <div className={`mx-auto fixed top-0 left-0 right-0 z-50 bg-base-200
                             transition-all duration-300 py-1 sm:py-2
                             md:py-3 w-full ${isScrolled ? 'shadow-md' : ''}`}>
                <div className="container w-[90%] flex gap-2 sm:gap-3 md:gap-6 items-center justify-between mx-auto px-0">
                    ...
                    <div className="flex justify-end items-center gap-1
                        ...
                        <button
                            className="btn btn-ghost btn-circle md:hidden p-1 sm:p-2"
                        ...
                        <button
                            ...
                            className="md:hidden btn btn-ghost btn-circle p-1 sm:p-2 hover:bg-transparent">
                            <div className="indicator">
                                <svg className="w-5 h-5 sm:w-6 sm:h-6"
                                    viewBox="0 0 24 24"
                                    fill="none"
            ...
            <div className={`fixed inset-0 z-[60] md:hidden transition-all duration-300 ease-in-out
